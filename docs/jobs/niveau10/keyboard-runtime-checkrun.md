...
generated: 2026-07-14T11:57:18Z  runner: sh  config: .architect/checkrun-keyboard-runtime-v5.json
check_file: docs/checks/niveau10/keyboard-runtime.md  freeze_sha: e08ef425cfd50b1491ef5771ff86c595b7f2f63c
Executor: bash
executor_config: bash
integrity: check_file_matches_freeze=true head=d175e9b8e1bd8c56ff3d5c41235e7f8f47be802e
changed_files: 14 listed below; docs_checks_touched=false
...
KeyboardLayoutMap API is not supported in this browser
 ...
 ✓ lib/hotkeys/keyboard-runtime.test.tsx (6 tests) 10ms

 Test Files  3 passed (3)
      Tests  35 passed (35)
   Start at  01:57:18
   Duration  509ms (transform 105ms, setup 0ms, collect 170ms, tests 19ms, environment 674ms, prepare 176ms)
...
(node:1288) Warning: The 'NO_COLOR' env is ignored due to the 'FORCE_COLOR' env being set.
...
✔ [paraglide-js] Compilation complete (message-modules)
transforming...
(node:1347) Warning: The 'NO_COLOR' env is ignored due to the 'FORCE_COLOR' env being set.
(Use `node --trace-warnings ...` to show where the warning was created)
