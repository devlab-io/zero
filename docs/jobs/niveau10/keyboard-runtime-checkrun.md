...
generated: 2026-07-14T11:55:46Z  runner: sh  config: .architect/checkrun-keyboard-runtime-v5.json
check_file: docs/checks/niveau10/keyboard-runtime.md  freeze_sha: e08ef425cfd50b1491ef5771ff86c595b7f2f63c
Executor: bash
executor_config: bash
integrity: check_file_matches_freeze=true head=e08ef425cfd50b1491ef5771ff86c595b7f2f63c
...
KeyboardLayoutMap API is not supported in this browser
 ...
 ✓ lib/hotkeys/keyboard-runtime.test.tsx (6 tests) 9ms

 Test Files  3 passed (3)
      Tests  35 passed (35)
   Start at  01:55:46
   Duration  434ms (transform 104ms, setup 0ms, collect 183ms, tests 17ms, environment 575ms, prepare 116ms)
...
exit: 0  ms: 21094  bytes: 35360 truncated
(node:92329) Warning: The 'NO_COLOR' env is ignored due to the 'FORCE_COLOR' env being set.
...
Finished in 22ms on 357 files using 18 threads.
...
(node:92509) Warning: The 'NO_COLOR' env is ignored due to the 'FORCE_COLOR' env being set.
(Use `node --trace-warnings ...` to show where the warning was created)
...
Found 3 warnings and 0 errors.
Finished in 11ms on 357 files using 18 threads.
...
exit: 0  ms: 44  bytes: 0

## RUN line 13
$ git diff --check
exit: 0  ms: 20  bytes: 0
