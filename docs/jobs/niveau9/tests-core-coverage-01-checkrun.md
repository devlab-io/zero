...
generated: 2026-07-13T20:03:33Z  runner: sh  config: /Users/thomasverdenne/cc/zero/.architect/checkrun-tests-core-01.json
check_file: docs/checks/niveau9/tests.md  freeze_sha: e03908929ac26061ccb48472f18d00b5270d0975
Executor: bash
executor_config: bash
integrity: check_file_matches_freeze=true head=23bde1e7ffeac3dfa3756da92a7fa575f6281c0f
...
$ pnpm test
exit: 0  ms: 3873  bytes: 9182 truncated
...
@zero/server:test:  ✓ src/env-schema.boot.test.ts (23 tests) 7ms
...
@zero/server:test:  ✓ src/lib/draft-outbox/state-machine.test.ts (4 tests) 4ms
@zero/server:test:  ✓ src/lib/auth-providers.test.ts (7 tests) 5ms
@zero/server:test:  ✓ src/lib/driver/gmail-batch.test.ts (17 tests) 20ms
@zero/server:test:  ✓ src/routes/agent/mcp-tools.test.ts (20 tests) 14ms
@zero/server:test:  ✓ src/trpc/routes/mail.test.ts (43 tests) 18ms
@zero/server:test:  ✓ src/lib/mail-sanitize/index.test.ts (3 tests) 77ms
@zero/server:test:  ✓ src/lib/driver/google-transport.test.ts (20 tests) 14ms
...
@zero/mail:test:  ✓ lib/draft-storage.test.ts (7 tests) 4ms
...
@zero/mail:test:  ✓ lib/query-retry.test.ts (6 tests) 56ms
