...
generated: 2026-07-13T19:17:03Z  runner: sh  config: /Users/thomasverdenne/cc/zero/.architect/checkrun-tests-core-01.json
check_file: docs/checks/niveau9/tests.md  freeze_sha: b6876bb98cdc0cd8df6a772362c3d88a41508d26
Executor: bash
executor_config: bash
integrity: check_file_matches_freeze=true head=560755e46eb633916f31c453178db6a7f0955ce6
...
$ pnpm test
exit: 0  ms: 3544  bytes: 6451 truncated
...
@zero/server:test: cache bypass, force executing 1193781b2a586ae0
@zero/server:test: 
...
@zero/server:test:  ✓ src/lib/driver/gmail-batch.test.ts (17 tests) 23ms
@zero/server:test:  ✓ src/lib/driver/gmail-backoff.test.ts (17 tests) 5ms
...
@zero/server:test:  ✓ src/lib/draft-outbox/state-machine.test.ts (4 tests) 6ms
...
@zero/server:test:  ✓ src/lib/auth-providers.test.ts (7 tests) 5ms
@zero/server:test:  ✓ src/routes/agent/mcp-tools.test.ts (20 tests) 10ms
@zero/server:test:  ✓ src/trpc/routes/mail.test.ts (43 tests) 20ms
@zero/server:test:  ✓ src/lib/driver/google-transport.test.ts (20 tests) 43ms
...
@zero/mail:test:  ✓ components/mail/mail-list-thread.test.ts (5 tests) 2ms
@zero/mail:test:  ✓ lib/optimistic-actions-manager.test.ts (4 tests) 2ms
@zero/mail:test:  ✓ components/mail/reply-recipients.test.ts (17 tests) 3ms
@zero/mail:test:  ✓ store/optimistic-updates.test.ts (6 tests) 5ms
@zero/mail:test: stderr | hooks/use-optimistic-actions.test.ts > useOptimisticActions — markAsRead (silent = exécution directe) > chemin d’erreur : mutation rejette → toast.error + nettoyage
@zero/mail:test: Action failed: Error: net
@zero/mail:test:     at [90m/Users/thomasverdenne/cc/zero/.architect/wt/niveau9/tests-core-coverage-01/apps/mail/[39mhooks/use-optimistic-actions.test.ts:145:68
...
@zero/mail:test:     at runWithTimeout (file:///Users/thomasverdenne/cc/zero/.architect/wt/niveau9/tests-core-coverage-01/node_modules/[4m.pnpm[24m/@vitest+runner@3.2.7/node_modules/[4m@vitest/runner[24m/dist/chunk-hooks.js:1863:10)
@zero/mail:test:     at runTest (file:///Users/thomasverdenne/cc/zero/.architect/wt/niveau9/tests-core-coverage-01/node_modules/[4m.pnpm[24m/@vitest+runner@3.2.7/node_modules/[4m@vitest/runner[24m/dist/chunk-hooks.js:1574:12)
@zero/mail:test:     at runSuite (file:///Users/thomasverdenne/cc/zero/.architect/wt/niveau9/tests-core-coverage-01/node_modules/[4m.pnpm[24m/@vitest+runner@3.2.7/node_modules/[4m@vitest/runner[24m/dist/chunk-hooks.js:1729:8)
