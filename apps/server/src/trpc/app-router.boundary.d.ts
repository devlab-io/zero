        ...
        unsend: import('@trpc/server').TRPCMutationProcedure<{
          ...
          output:
            ...
            | {
                readonly success: false;
                readonly error:
                  | 'Too late to cancel (status: failed)'
                  | 'Too late to cancel (status: sending)'
                  | 'Too late to cancel (status: sent)'
                  | 'Too late to cancel (status: queued)'
                  | 'Too late to cancel (status: cancelled)';
              }
            | {
                readonly success: false;
