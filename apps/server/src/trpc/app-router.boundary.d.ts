...
export declare const appRouter: import("@trpc/server").TRPCBuiltRouter<{
    ...
    copilot: import("@trpc/server").TRPCBuiltRouter<{
        ...
        setCredential: import("@trpc/server").TRPCMutationProcedure<{
            input: {
                provider: "anthropic" | "openai" | "openrouter" | "gemini" | "moonshot" | "zai";
    ...
    outbox: import("@trpc/server").TRPCBuiltRouter<{
        ...
        list: import("@trpc/server").TRPCQueryProcedure<{
            input: {
                status?: "failed" | "sending" | "sent" | "queued" | "generating" | "draft_ready" | "approved" | "cancelled" | "no_reply_needed" | undefined;
            } | undefined;
        ...
        prepareQueue: import("@trpc/server").TRPCMutationProcedure<{
            input: {
        ...
        listTriageRuns: import("@trpc/server").TRPCQueryProcedure<{
            input: void;
            output: {
                id: string;
                userId: string;
        ...
        requestRevision: import("@trpc/server").TRPCMutationProcedure<{
            input: {
                id: string;
                instruction: string;
            };
        ...
        retryRevision: import("@trpc/server").TRPCMutationProcedure<{
            input: {
                id: string;
            };
            output: {
        ...
        updateDraft: import("@trpc/server").TRPCMutationProcedure<{
            ...
            output: {
                ...
                threadId: string | null;
                mission: string | null;
                status: "failed" | "sending" | "sent" | "queued" | "generating" | "draft_ready" | "approved" | "cancelled" | "no_reply_needed";
                ...
                classification: "no_reply_needed" | "reply_needed";
                classificationReason: string | null;
                generationMode: "server" | "codex";
                reviewState: "pending" | "failed" | "revision_requested" | "revising" | "ready" | "stale";
        ...
        listWorkerDevices: import("@trpc/server").TRPCQueryProcedure<{
            input: void;
            output: {
                enrolled: boolean;
                id: string;
        ...
        createWorkerEnrollment: import("@trpc/server").TRPCMutationProcedure<{
            input: {
                name?: string | undefined;
            };
            output: {
        ...
        revokeWorkerDevice: import("@trpc/server").TRPCMutationProcedure<{
            input: {
                id: string;
            };
            output: {
        ...
        threadDraftReview: import("@trpc/server").TRPCQueryProcedure<{
            ...
            output: {
                review: ({
                    ...
                    ownerUserId: string;
                    reviewerUserId: string;
                    state: "completed" | "approved" | "cancelled" | "requested" | "changes_requested";
                    revision: number;
                    draftDigest: string;
                    createdAt: Date;
                    updatedAt: Date;
