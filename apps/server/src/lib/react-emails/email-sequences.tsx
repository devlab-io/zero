// Devlab/perf — imports par sous-chemins plutôt que par le barrel
// `@react-email/components`. Le barrel réexporte tout le catalogue, dont
// `@react-email/code-block` (715 kB, prismjs) et `@react-email/tailwind`
// (640 kB, + postcss 128 kB), qu'aucun de ces gabarits n'utilise : ces
// 1,48 Mio entraient dans le graphe du Worker sans qu'une seule ligne ne
// s'en serve. Les neuf composants réellement employés sont ci-dessous.
