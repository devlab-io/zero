...
const points = [
  ...
  },
  {
    ...
    detail: 'Every shared thread has one owner and one status. No “who has this?” ever again.',
  },
  {
  ...
  return (
    <section className="relative mt-32 px-4 md:mt-40">
      ...
      <div className="mx-auto grid w-full max-w-[1100px] grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-[#2A2A2A] dark:bg-[#1A1A1A]">
