...
export function ThreadDisplay() {
  ...
  // Devlab/perf — chaque pièce garde l'identifiant de SON message. Les corps
  // arrivent vides dans la projection du fil : sans cette provenance, la
  // rangée de pièces jointes ne pouvait pas aller chercher les octets et
  // téléchargeait des fichiers vides (atob('') → blob de 0 octet).
